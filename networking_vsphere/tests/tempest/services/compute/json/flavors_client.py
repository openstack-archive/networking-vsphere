...
from networking_vsphere.tests.tempest.api_schema.response.compute import flavors as common_schema
from networking_vsphere.tests.tempest.api_schema.response.compute import flavors_access as schema_access
from networking_vsphere.tests.tempest.api_schema.response.compute import flavors_extra_specs \
    as schema_extra_specs
from networking_vsphere.tests.tempest.api_schema.response.compute.v2_1 import flavors as v2schema
