...
from networking_vsphere.tests.tempest.api_schema.response.compute import hosts as schema
from networking_vsphere.tests.tempest.api_schema.response.compute.v2_1 import hosts as v2_schema
