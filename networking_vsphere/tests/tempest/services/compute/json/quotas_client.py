...
from networking_vsphere.tests.tempest.api_schema.response.compute.v2_1\
    import quota_classes as classes_schema
from networking_vsphere.tests.tempest.api_schema.response.compute.v2_1 import quotas as schema
