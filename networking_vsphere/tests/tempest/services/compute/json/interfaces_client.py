...
from networking_vsphere.tests.tempest.api_schema.response.compute import servers as servers_schema
from networking_vsphere.tests.tempest.api_schema.response.compute.v2_1 import interfaces as schema
