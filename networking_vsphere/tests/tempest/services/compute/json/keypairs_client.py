...
from networking_vsphere.tests.tempest.api_schema.response.compute import keypairs as common_schema
from networking_vsphere.tests.tempest.api_schema.response.compute.v2_1 import keypairs as schema
