...
from networking_vsphere.tests.tempest.common import cred_provider
from networking_vsphere.tests.tempest.common import negative_rest_client
from networking_vsphere.tests.tempest import config
from networking_vsphere.tests.tempest import manager
from networking_vsphere.tests.tempest.services.baremetal.v1.json.baremetal_client import \
    BaremetalClientJSON
from networking_vsphere.tests.tempest.services import botoclients
from networking_vsphere.tests.tempest.services.compute.json.agents_client import \
    AgentsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.aggregates_client import \
    AggregatesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.availability_zone_client import \
    AvailabilityZoneClientJSON
from networking_vsphere.tests.tempest.services.compute.json.baremetal_nodes_client import \
    BaremetalNodesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.certificates_client import \
    CertificatesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.extensions_client import \
    ExtensionsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.fixed_ips_client import FixedIPsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.flavors_client import FlavorsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.floating_ips_client import \
    FloatingIPsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.hosts_client import HostsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.hypervisor_client import \
    HypervisorClientJSON
from networking_vsphere.tests.tempest.services.compute.json.images_client import ImagesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.instance_usage_audit_log_client import \
    InstanceUsagesAuditLogClientJSON
from networking_vsphere.tests.tempest.services.compute.json.interfaces_client import \
    InterfacesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.keypairs_client import KeyPairsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.limits_client import LimitsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.migrations_client import \
    MigrationsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.networks_client import NetworksClientJSON
from networking_vsphere.tests.tempest.services.compute.json.quotas_client import QuotaClassesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.quotas_client import QuotasClientJSON
from networking_vsphere.tests.tempest.services.compute.json.security_group_default_rules_client import \
    SecurityGroupDefaultRulesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.security_groups_client import \
    SecurityGroupsClientJSON
from networking_vsphere.tests.tempest.services.compute.json.servers_client import ServersClientJSON
from networking_vsphere.tests.tempest.services.compute.json.services_client import ServicesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.tenant_networks_client import \
    TenantNetworksClientJSON
from networking_vsphere.tests.tempest.services.compute.json.tenant_usages_client import \
    TenantUsagesClientJSON
from networking_vsphere.tests.tempest.services.compute.json.volumes_extensions_client import \
...
from networking_vsphere.tests.tempest.services.identity.v2.json.identity_client import \
    IdentityClientJSON
from networking_vsphere.tests.tempest.services.identity.v2.json.token_client import TokenClientJSON
from networking_vsphere.tests.tempest.services.identity.v3.json.credentials_client import \
    CredentialsClientJSON
from networking_vsphere.tests.tempest.services.identity.v3.json.endpoints_client import \
    EndPointClientJSON
from networking_vsphere.tests.tempest.services.identity.v3.json.identity_client import \
    IdentityV3ClientJSON
from networking_vsphere.tests.tempest.services.identity.v3.json.policy_client import PolicyClientJSON
from networking_vsphere.tests.tempest.services.identity.v3.json.region_client import RegionClientJSON
from networking_vsphere.tests.tempest.services.identity.v3.json.service_client import \
    ServiceClientJSON
from networking_vsphere.tests.tempest.services.identity.v3.json.token_client import V3TokenClientJSON
from networking_vsphere.tests.tempest.services.image.v1.json.image_client import ImageClientJSON
from networking_vsphere.tests.tempest.services.image.v2.json.image_client import ImageClientV2JSON
#from networking_vsphere.tests.tempest.services.messaging.json.messaging_client import \
#    MessagingClientJSON
from networking_vsphere.tests.tempest.services.network.json.network_client import NetworkClientJSON
