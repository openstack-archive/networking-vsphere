...
from networking_vsphere.tests.tempest.services.identity.v2.json import token_client as json_v2id
from networking_vsphere.tests.tempest.services.identity.v3.json import token_client as json_v3id
