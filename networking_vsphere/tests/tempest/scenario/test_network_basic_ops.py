...
class TestNetworkBasicOps(manager.NetworkScenarioTest):
    ...
    @test.attr(type='smoke')
    @test.services('compute', 'network')
    def test_update_instance_network_admin_state(self):
        """
        1. Check public connectivity before updating
                admin_state_up attribute of instance network to False
        2. Check public connectivity after updating
                admin_state_up attribute of instance network to False
        3. Check public connectivity after updating
                admin_state_up attribute of instance network to True
        """
        self._setup_network_and_servers()
        self.check_public_network_connectivity(
            should_connect=True, msg="before updating "
            "admin_state_up of instance network to False")
        self.network_client.update_network(self.network.id,
        ...
        self.check_public_network_connectivity(
            should_connect=True, msg="after updating "
            "admin_state_up of instance network to True")
