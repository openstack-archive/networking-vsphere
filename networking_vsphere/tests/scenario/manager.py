...
class ESXNetworksTestJSON(base.BaseAdminNetworkTest,
    ...
    def vcenter(self, vcenter_ip, vcenter_username, vcenter_password):
        vcenter_connect = None
        try:
                msg = 'Trying to connect .....'
                LOG.info(msg)
                vcenter_connect = connect.Connect(vcenter_ip, 443, vcenter_username,
    ...
    def _portgroup_verify(self, portgroup, segmentid):
        vcenter_ip = cfg.CONF.esx.vcenter_ip
        trunk_dvswitch_name = cfg.CONF.esx.trunk_dvswitch_name
        vcenter_username = cfg.CONF.esx.vcenter_username
        vcenter_password = cfg.CONF.esx.vcenter_password
        content = self.vcenter(vcenter_ip, vcenter_username, vcenter_password)
