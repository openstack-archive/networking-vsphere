...
from networking_vsphere.tests.tempest import clients
from networking_vsphere.tests.tempest.common import credentials
from networking_vsphere.tests.tempest.common import fixed_network
from networking_vsphere.tests.tempest.common.utils.linux import remote_client
from networking_vsphere.tests.tempest import config
import networking_vsphere.tests.tempest.test
...
class ScenarioTest(networking_vsphere.tests.tempest.test.BaseTestCase):
    ...
    def get_remote_client(self, server_or_ip, username=None, private_key=None,
        ...
        try:
            ...
            msg = _('Initializing SSH connection to %s failed')
            LOG.exception(msg % ip)
    ...
    def ping_ip_address(self, ip_address, should_succeed=True,
        ...
        return networking_vsphere.tests.tempest.test.call_until_true(
            ping, timeout, 1)
...
class NetworkScenarioTest(ScenarioTest):
    ...
    def check_floating_ip_status(self, floating_ip, status):
        ...
        networking_vsphere.tests.tempest.test.call_until_true(
            refresh, CONF.network.build_timeout, CONF.network.build_interval)
    ...
    def _check_tenant_net_connectivity(self, server,
        ...
        try:
            ...
            msg = _('Tenant network connectivity check failed')
            LOG.exception(msg)
    ...
    def _check_remote_connectivity(self, source, dest, should_succeed=True):
        ...
        return networking_vsphere.tests.tempest.test.call_until_true(
            ping_remote, CONF.compute.ping_timeout, 1)
...
class BaremetalScenarioTest(ScenarioTest):
    ...
    def _node_state_timeout(self, node_id, state_attr,
        ...
        if not networking_vsphere.tests.tempest.test.call_until_true(
