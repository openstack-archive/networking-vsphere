...
class ESXNetworksTestJSON(base.BaseAdminNetworkTest,
    ...
    def _vcenter_connect(self, vcenter_ip, vcenter_username, vcenter_password):
        vcenter_connect = None
        try:
                msg = 'Trying to connect .....'
                LOG.info(msg)
                vcenter_connect = connect.Connect(vcenter_ip, 443,
                                                  vcenter_username,
                                                  vcenter_password,
                                                  service="hostd")
        except Exception:
        ...
        atexit.register(Disconnect, vcenter_connect)
    ...
    def _portgroup_verify(self, portgroup, segmentid):
        ...
        content = self._vcenter_connect(vcenter_ip, vcenter_username,
                                        vcenter_password)
