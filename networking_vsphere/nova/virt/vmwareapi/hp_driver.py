...
class HPVMwareVCDriver(vmware_driver.VMwareVCDriver):
    def __init__(self, virtapi, scheme="https"):
        super(HPVMwareVCDriver, self).__init__(virtapi, scheme)
    ...
    def _get_mo_id_from_instance(self, instance):
        ...
        This will be of the form - '<cluster-moid>.<vcenter_uuid>'
        eg: 'domain-1001.14594e20-5f0c-44ae-b5db-253ccf711483'
        """
    ...
    def _create_virtual_nic(self, instance, image_info, network_info, vm_ref):
        ...
        for vif in network_info:
            ...
            if network_id is None or mac_address is None:
                continue
    ...
    def _wait_and_get_portgroup_details(self, session, vm_ref,
        ...
        while count < max_counts:
            host = session._call_method(vutil, "get_object_property",
                                        vm_ref, "runtime.host")
            vm_networks_ret = session._call_method(vutil,
                                                   "get_object_property",
                                                   host, "network")
            if vm_networks_ret is None:
                return None
            ...
            for network in vm_networks:
                ...
                if network._type == 'DistributedVirtualPortgroup':
                    ...
                    netname = session._call_method(vutil,
                                                   "get_object_property",
                                                   network,
                                                   "name")
