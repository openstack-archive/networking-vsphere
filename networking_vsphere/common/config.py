...
OVSVAPP_OPTS = [
    ...
    cfg.StrOpt('integration_patch_port',
               default='patch-integration',
               help='OVS integration patch port.'),
    cfg.StrOpt('security_patch_port',
               default='patch-security',
               help='OVS security patch port.'),
