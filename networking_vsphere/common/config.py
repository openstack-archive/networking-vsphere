...
# vapp related config read from ovsvapp_agent.ini
agent_opts = [
...
# vapp related config read from neutron.conf
OVSVAPPAGENT_OPTS = [
...
# ESX host and vCenter related config read from ovsvapp_agent.ini
VMWARE_OPTS = [
