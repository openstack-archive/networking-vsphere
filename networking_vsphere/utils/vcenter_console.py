...
class VcenterConsole(VcenterProxy):
    ...
    def get_all_dvs(self):
        return self.get_all_objects_of_type(
            "DistributedVirtualSwitch").objects
    ...
    def get_all_hosts(self):
        return str(self.get_hosts()[0])

    @property
    def get_all_clusters(self):
        return str(self.get_all_objects_of_type('ClusterComputeResource'))
