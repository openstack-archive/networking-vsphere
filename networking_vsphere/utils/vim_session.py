...
class VMWareAPISession(api.VMwareAPISession):
    ...
    def __init__(self, host_ip, host_username, host_password, api_retry_count,
                 wsdl_url, connection_timeout=None, scheme="https",
                 https_port=443, create_session=True, ca_cert=None):
