...
class OVSvAppAgent(agent.Agent, ovs_agent.OVSNeutronAgent):
    ...
    def setup_security_br(self):
        ...
        self.int_br.delete_port(CONF.OVSVAPP.security_patch_port)
        self.sec_br.delete_port(CONF.OVSVAPP.integration_patch_port)
        ...
        if br_name is not None:
            if br_name != secbr_name:
                br = ovs_lib.OVSBridge(br_name)
                br.delete_port(CONF.OVSVAPP.integration_patch_port)
