...
class OVSvAppSecurityGroupAgent(sg_rpc.SecurityGroupAgentRpc):
            ...
            if port_id is not None:
                deleted_dev, deleted_dev_group = \
                    self._remove_from_sgid_device_map(
                        ...
                        remove_list)
            self._remove_device_remote_rules(deleted_dev, deleted_dev_group)
    ...
    def _remove_device_remote_rules(self, deleted_dev, deleted_dev_group):
