...
class OVSFirewallDriver(firewall.FirewallDriver):
    ...
    def _add_ovs_flow(self, sg_br, priority, table_id, action,
    ...
    def _get_icmp_learn_flow_action(self, resType):
    ...
    def _setup_learning_flows(self, sec_br):
        ...
        learned_tcp_flow = ("table=%s,"
                            ...
                            (SG_LEARN_TABLE_ID,
                            SG_TP_PRI,
                            constants.PROTO_NUM_TCP, common_string))
        ...
        learned_udp_flow = ("table=%s,"
                            ...
                            (SG_LEARN_TABLE_ID,
                            SG_TP_PRI,
                            constants.PROTO_NUM_UDP, common_string))
        self._add_ovs_flow(sec_br,SG_TP_PRI,
                           SG_UDP_TABLE_ID,
